...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen lg:h-screen flex flex-col lg:flex-row lg:overflow-hidden">
      ...
      {/* ── Mobile: compact blue banner on top (phones & small tablets) ── */}
      <div className="lg:hidden bg-[#0f172a] px-6 pt-8 pb-7 relative overflow-hidden flex-shrink-0">
